...
fn draw_help_overlay(f: &mut Frame, app: &App) {
    ...
    let mut lines = vec![
        ...
        Line::from("    S+K/\u{2191}   Nudge up (double-tap: fling to top)"),
        Line::from("    S+J/\u{2193}   Nudge down (double-tap: fling to bottom)"),
        Line::from("    p       Cycle gap below item (S/M/L/XL)"),
        Line::from("    r       Toggle personal/global"),
        Line::from("    C-z     Undo ordering change"),
