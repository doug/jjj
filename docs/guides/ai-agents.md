...
mkdir -p ~/.claude/skills/jjj && \
  curl -fsSL https://jjj.recursivewhy.com/jjj-skill.md \
...
```
https://jjj.recursivewhy.com/jjj-skill.md
```
...
The skill file at `jjj.recursivewhy.com/jjj-skill.md` is updated with each release. Re-run the install command to get the latest version:
